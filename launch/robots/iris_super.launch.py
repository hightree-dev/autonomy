...
def generate_robot_launch_actions(context: LaunchContext, *args, **kwargs):
    ...
    sdf_file = os.path.join(
        pkg_autonomy_bringup, "models", "iris_super", "model.sdf"
    )
    ...
    robot_desc = robot_desc.replace(
        ...
        "package://autonomy_bringup/models/iris_with_standoffs",
    )
    robot_desc = robot_desc.replace(
        "model://lidar_3d", "package://autonomy_bringup/models/lidar_3d"
    )
    ...
    bridge_config_file = os.path.join(
        pkg_autonomy_bringup, "config", "iris_3Dlidar_bridge.yaml"
    )
...
def generate_launch_arguments() -> List[DeclareLaunchArgument]:
    ...
    return [
        ...
        DeclareLaunchArgument(
            ...
            description="Set path to default params for the iris_super with DDS.",
        ),
        DeclareLaunchArgument(
            "synthetic_clock",
            default_value="True",
